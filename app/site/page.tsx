  ...
  return (
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <p className="text-center mt-20">Run your agency, in one place</p>
      ...
      <section className="flex justify-center items-center flex-col gap-4 -mt-0 md:mt-40">
            ...
            >
              ...
              <CardContent>
                <span className="text-4xl font-bold">
                  {card.unit_amount ? card.unit_amount / 100 : 0}
                </span>
              ...
              <CardFooter className="flex flex-col items-start gap-4">
                <div>
                  {pricingCards
                    .find((item) => item.title === card.nickname)
